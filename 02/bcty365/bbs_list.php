        ...
        <div class="bbs-table">
            ...
            <table width="750" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                ...
                if ($total == 0) {
                    ...
                    <?php
                    $sql = mysqli_query($conn, "select * from tb_bbs where  typeid='" . $typeid . "' order by top desc,createtime desc,lastreplytime desc limit " . ($page - 1) * $pagesize . ",$pagesize");
                    while ($info = mysqli_fetch_array($sql)) {
                        ...
                        <tr>
                            ...
                            <td height="23" bgcolor="#E9F3FF">
                                <div align="center">
                                    <?php
                                    $sql1 = mysqli_query($conn, "select count(*) as total from tb_reply where bbsid='" . $info['id'] . "'");
                            ...
                            <td height="23" bgcolor="#E9F3FF">
                                <div align="center">
                                    <?php
                                    $sql1 = mysqli_query($conn, "select usernc from tb_user where id='" . $info['userid'] . "'");
                                    $info1 = mysqli_fetch_array($sql1);
                                    echo $info1['usernc'];
                                    ?>
                                </div>
                        ...
                        <tr id="tr<?php echo $info['id']; ?>" style="display:none">
                            ...
                            <td height="23" colspan="5" bgcolor="#E9F3FF">
                                <table width="650" height="25" border="0" align="center" cellpadding="0"
                                       cellspacing="0">
                                    <?php
                                    $sqlr = mysqli_query($conn, "select * from tb_reply where  bbsid='" . $info['id'] . "' order by createtime asc");
