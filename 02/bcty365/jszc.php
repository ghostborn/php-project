                        ...
                        do {
                            ...
                            <div class="soft-download">
                                <a href="softinfo.php?id=<?php echo $infouwz["id"]; ?>" class="a1">
                                    ...
                                    echo "<span style='color:red'>[" . substr(str_replace("-", "/", $infouwz['addtime']), 0, 10) . "]</span>";
                                    ?>
                                </a>
                            </div>
                            <?php
                                ...
                                <li>
                                    ...
                                    <a style="margin-left:12px;" href="lookcjwt.php?id=<?php echo $infouwz["id"]; ?>"
                                       class="a1" target="_blank">
                                        ...
                                        echo "<span style='color:red'>[" . substr(str_replace("-", "/", $infouwz['createtime']), 0, 10) . "]</span>";
                                        ?>
                                    </a>
                                </li>
                        ...
                        if ($infouwz == false) {
                            ...
                            do {
                                ...
                                <li>
                                    ...
                                    $sqlt = mysqli_query($conn, "select id  from tb_type where id='" . $infouwz["typeid"] . "'");
