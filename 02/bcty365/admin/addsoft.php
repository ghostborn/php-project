...
<table width="565" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
    <form name="form1" method="post" action="savesoft.php" onSubmit="return chkinput(this)"
          enctype="multipart/form-data">
        <tr>
            <td height="22" class="a5" colspan="2"><?php echo $_GET['htgl']; ?></td>
        </tr>
        <tr>
            <td width="116" height="25" bgcolor="#FFFFFF">
                <div align="center">软件名称：</div>
            </td>
            <td width="436" bgcolor="#FFFFFF">&nbsp;
                <input type="text" name="softname" size="50" class="txt_grey">
            </td>
        </tr>
        <tr>
            ...
            <td height="150" bgcolor="#FFFFFF">&nbsp;
                <textarea name="content" rows="10" cols="60" class="textarea"></textarea>
            </td>
        </tr>
        <tr>
            <td height="25" bgcolor="#FFFFFF">
                <div align="center">软件地址：</div>
            </td>
