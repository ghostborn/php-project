...
<table width="565" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
    ...
    $sql = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tb_cjwt");
    ...
    if ($total == 0) {
        ...
        ?>
        <tr>
            <td height="25" colspan="3" class="a5" align="center"><?php echo $_GET['htgl']; ?></td>
        </tr>
        <tr>
            <td width="336" height="25" align="right" bgcolor="#F7F7F7">
                <div align="center">常见问题</div>
            </td>

            <td width="297" bgcolor="#F7F7F7">
        ...
        while ($info = mysqli_fetch_array($sql)) {
            ...
            <tr>
                <td height="25" align="right" bgcolor="#F7F7F7">
                    <div align="left">&nbsp;<?php echo unhtml($info['question']); ?></div>
                </td>
                <td height="25" align="right" bgcolor="#F7F7F7">
                    <div align="left"><?php echo unhtml($info['answer']); ?></div>
                </td>
                <td height="25" align="right" bgcolor="#F7F7F7">
                    <div align="center">
                        <a href="default.php?htgl=编辑常见问题&mtid=<?php echo $info['id']; ?>"></a>
                        <a href="javascript:if(window.confirm('您确定删除该常见问题么？')==true){window.location.href='deletecjwt.php?id=<?php echo $info['id']; ?>';}"><img
                                    src="images/del.gif" width="22" height="22" border="0">
                        </a>
                    </div>
                </td>
            </tr>
...
<table width="560" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="303" height="20">
            <div align="left">共有问题<?php echo $total; ?>个&nbsp;每页显示<?php echo $pagesize ?>
        ...
        <td width="257">
            <div align="right">
                ...
                if ($page >= 2) {
                    ...
                    <a href="default.php?htgl=编辑常见问题&page=<?php echo $page - 1; ?>" title="前一页"><font
                ...
                if ($pagecount <= 4) {
                    ...
                    <a href="default.php?htgl=编辑常见问题&page=<?php echo $pagecount; ?>" title="尾页"><font
