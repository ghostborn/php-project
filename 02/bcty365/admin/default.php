...
<table width="830" align="center">
    <tr>
        <td><img src="images/bg_16_2.jpg" width="830" height="139" border="0" usemap="#Map"></td>
    </tr>
</table>
                ...
                <tr>
                    <td height="33" colspan="3" background="images/bg_16_6.jpg">
                        <table width="625" height="30" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td height="20"><?php echo isset($_GET['htgl']) ? $_GET['htgl'] : ""; ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
<map name="Map">
    <area shape="rect" coords="641,114,717,136" href="../index.php">
    <area shape="rect" coords="732,114,808,136" href="logout.php">
</map>
</body>
</html>
