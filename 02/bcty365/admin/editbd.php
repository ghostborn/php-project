...
<table width="565" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
    <tr>
        <td height="22" colspan="3" align="center"><span class="a5"><?php echo $_GET['htgl']; ?></span></td>
    </tr>
    <tr>
    ...
    $sql = mysqli_query($conn, "SELECT * FROM tb_bb ORDER BY createtime DESC");
        ...
        do {
            ...
            <tr>
                <td height="22" bgcolor="#FFFFFF">
                    <div align="center"><?php echo unhtml($info['bbname']); ?></div>
                </td>
                ...
                <td height="22" bgcolor="#FFFFFF">
                    <div align="center">
                        <a href="javascript:if(window.confirm('您确定删除该编程词典版本么?')==true){window.location.href='deletebb.php?id=<?php echo $info['id']; ?>';}"><img
