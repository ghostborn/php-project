...
//将表单中提交的数据存储到数据库中
$query = mysqli_query($conn, "insert into tb_bccd(bccdname,owner,typeid,content,samepart,imageaddress,addtime) values('$bccdname','$owner','$typeid','$content','$samepart','$imageaddress','$addtime')");
if ($query == true) {
