...
<table width="565" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
    ...
    <form name="form1" method="post" action="savetell.php" onSubmit="return chkinput(this)"
          enctype="multipart/form-data">
        <tr>
            <td height="25" colspan="2" align="center" class="a5"><?php echo $_GET['htgl']; ?></td>
        </tr>
        <tr>
            <td width="91" height="25" bgcolor="#FFFFFF">
                <div align="center">公告标题：</div>
            </td>
            <td width="506" bgcolor="#FFFFFF">&nbsp;
                <input name="title" type="text" class="txt_grey" id="title" size="25">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td height="25" bgcolor="#FFFFFF">&nbsp;
                <textarea name="content" rows="10" cols="70" class="textarea"></textarea>
            </td>
        </tr>
        <tr>
            <td height="25" colspan="2" bgcolor="#FFFFFF">
                <div align="center"><input type="submit" value="添加" class="btn_grey">&nbsp;&nbsp;
