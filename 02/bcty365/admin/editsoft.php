...
if ($total == 0) {
    ...
    $sql = mysqli_query($conn, "select * from tb_soft order by addtime desc limit " . ($page - 1) * $pagesize . ",$pagesize");
    while ($info = mysqli_fetch_array($sql)) {
        ?>
        <table width="565" height="220" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
               bgcolor="#327387">
            <tr>
                <td height="25" colspan="3" align="center" class="a5"><?php echo $_GET['htgl']; ?></td>
            </tr>
            <tr>
                ...
                <td width="70" bgcolor="#ffffff">
                    <div align="center">
                        <a href="javascript:if(window.confirm('确定删除该下载软件么？')==true){window.location.href='deletesoft.php?id=<?php echo $info['id']; ?>';}"><img
                                    src="images/del.gif" width="22" height="22"></a>
                    </div>
                </td>
            </tr>
            <tr>
...
<table width="560" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="400" height="20">
            <div align="left">共有软件产品<?php echo $total; ?>条&nbsp;每页显示<?php echo $pagesize ?>
        ...
        <td width="300">
            <div align="right">
                ...
                if ($page >= 2) {
                    ...
                    <a href="default.php?htgl=编辑软件试用&page=<?php echo $page - 1; ?>" title="前一页"><font
                ...
                if ($pagecount <= 4) {
                    ...
                    <a href="default.php?htgl=编辑软件试用&page=<?php echo $pagecount; ?>" title="尾页"><font
