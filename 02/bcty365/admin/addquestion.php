...
<table width="565" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
    <form name="form1" method="post" action="savecjwt.php" onSubmit="return chkinput(this)">
        ...
        <tr>
            <td width="117" height="25" bgcolor="#FFFFFF">
        ...
        <tr>
            ...
            <td height="25" bgcolor="#FFFFFF">&nbsp;
                <textarea name="question" rows="10" cols="60" class="textarea"></textarea>
            </td>
        </tr>
        <tr>
            <td height="140" bgcolor="#FFFFFF">
            ...
            <td height="25" bgcolor="#FFFFFF">&nbsp;
                <textarea name="answer" rows="10" cols="60" class="textarea"></textarea>
            </td>
        </tr>
        <tr>
