...
<table width="870" height="250" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
       bgcolor="#6EBEC7">
    <tr>
                                ...
                                <td>
                                    <div align="center">
                                        <input name="button2" type="button"
                                               onclick="javascript:showget_u_p.style.display=''" value="我同意"/>
                                        &nbsp;&nbsp;
                                        <input name="button2" type="button"
                                               onclick="javascript:showget_u_p.style.display='none';window.location.href='index.php'"
                                               value="我不同意"/>
                                    </div>
                                </td>
                            </tr>
