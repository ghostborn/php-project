...
<table width="870" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#6EBEC7">
    <tr>
        <td bgcolor="#FFFFFF" valign="top">
            <table width="850" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td></td>
                </tr>
            </table>
                ...
                <tr>
                    <td bgcolor="#FFFFFF" valign="top">
                        <table width="750" height="20" border="0" align="center" cellpadding="0" cellspacing="0"
                               background="images/lt_15_2.jpg">
                            <tr>
                                <td height="2"></td>
                            </tr>
                            <tr>
                                <td width="740" class="a9">
                                    <div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户录入版块</div>
                                </td>
                                <td width="160"></td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td valign="top">
									...
									$sql = mysqli_query($conn,
										"select usernc from tb_user where usernc='" . $usernc . "'");
									...
									if ($info != false) { ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <div align="center"><font
                                                                color="#FF0000">对不起，您的用户名已被其他网友所占用，请重新选择！</font>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <form action="savereginfo.php" method="post" name="form1" id="form1"
                                                  onsubmit="return chkinput(this)">
                                                <tr>
                                                    <td height="30" colspan="3">
                                                        <div align="center">
                                                            <font color="#FF0000"><br>您已经成功的申请了本站的用户名：</font>&nbsp;
                                                            <font color="#0000FF"><?php echo $_POST["usernc"] ?></font>&nbsp;
                                                            <font color="#FF0000">如果注册为本站的用户，您还应该填写以下信息！</font><br><br>
                                                            <font color="#0000FF">注意：以下注册信息均为必添内容！</font>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div align="center">头像选择：</div>
                                                    </td>
                                                    <td width="100" height="30">
                                                        <select name="photo"
                                                                onchange="javascript:user_face.src=this.value">
															<?php
															for ($i = 0; $i <= 11; $i++) {
																?>
                                                    ...
                                                    <td width="393">
                                                        <img id=user_face src="images/face/0.gif" width="60"
                                                             height="60">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="30">
                                                        <div align="center">密码保护问题：</div>
                                                    </td>
                                                    <td height="30" colspan="2">&nbsp;
                                                        <select name="question">
                                                            <option value="" selected="selected">请选择一个问题</option>
                                                            <option value="我就读的第一所学校的名称？">
                                                                我就读的第一所学校的名称？
                                                            </option>
                                                            <option value="我最喜欢的休闲运动是什么？">
                                                                我最喜欢的休闲运动是什么？
                                                            </option>
                                                            <option value="我最喜欢的运动员是谁？">
                                                                我最喜欢的运动员是谁？
                                                            </option>
                                                            <option value="我最喜欢的物品的名称？">
                                                                我最喜欢的物品的名称？
                                                            </option>
                                                ...
                                                <tr>
                                                    <td height="30">
                                                        <div align="center">效验码：</div>
                                                    </td>
                                                    <td height="30" colspan="2">
                                                        <table width="400" height="30" border="0" align="left"
                                                               cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td width="162">&nbsp;
                                                                    <input type="text" name="xym" size="20"
                                                                           class="inputcss"/>
                                                                </td>
                                                                <td width="238">
																	<?php
																	...
																	for ($i = 0; $i < 4; $i++) {
																		echo "<img src=images/code/" . substr(strval($num),
																				$i, 1) . ".gif>";
																	}
																	?>
                                                                </td>
