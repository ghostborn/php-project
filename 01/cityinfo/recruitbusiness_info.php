                ...
                <tr>
                    <td height="96" align="center" valign="top">
						...
						$sgsql = mysqli_query($conn,
							"select * from tb_leaguerinfo  where type='招商引资' and showday>='$date1' and checkstate=1 ");
                ...
                <tr>
                    <td height="140" align="center" valign="top">
						...
						$sql = mysqli_query($conn,
							"SELECT COUNT(*) AS total FROM tb_info WHERE type='招商引资' AND checkstate=1");
						...
						$gsql = mysqli_query($conn,
							"select * from tb_info where type='招商引资' and checkstate=1 order by edate desc limit " . ($page - 1) * $pagesize . ",$pagesize");
                            ...
                            <table width="650" height="27" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="650" height="27" colspan="3" align="right">共有<?php
										...
										if ($page >= 2) {
											?>
                                            <a href="recruitbusiness.php?page=1" title="首页"></a>
                                            <a href="recruitbusiness.php?page=<?php echo $page - 1; ?>"
                                               title="前一页"></a>
											<?php
										}
										if ($pagecount <= 4) {
                                            ...
                                            <a href="recruitbusiness.php?page=<?php echo $page - 1; ?>"
                                               title="后一页"></a>
                                            <a href="recruitbusiness.php?page=<?php echo $pagecount; ?>"
                                               title="尾页"></a>
										<?php } ?>
                                    </td>
                                </tr>
