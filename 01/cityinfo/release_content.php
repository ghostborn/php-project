                ...
                <table width="630" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFFF4">
                    ...
                    <tr>
                        ...
                        <td width="433" height="30"><select name="type">
                            ...
                            &nbsp;<span class="style1">*&nbsp;请正确选择您要发布的信息类别</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr align="center">
                        <td height="80" colspan="2">
                            <input name="imageField" type="image" class="input1" src="Images/fa.jpg" width="145"
                                   height="46" border="0" onClick="return checkform(form);">
                        </td>
                    </tr>
                </table>
            </form>
