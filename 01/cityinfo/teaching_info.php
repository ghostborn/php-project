                ...
                <tr>
                    <td height="96" align="center" valign="top">
						...
						$sgsql = mysqli_query($conn,
							"select * from tb_leaguerinfo  where type='家教信息' and showday>='$date1' and checkstate=1 ");
                ...
                <tr>
                    <td height="140" align="center" valign="top">
						...
						$sql = mysqli_query($conn,
							"SELECT COUNT(*) AS total FROM tb_info WHERE type='家教信息' AND checkstate=1");
						...
						$gsql = mysqli_query($conn,
							"select * from tb_info where type='家教信息' and checkstate=1 order by edate desc limit " . ($page - 1) * $pagesize . ",$pagesize");
						...
						if ($ginfo) {
                            ...
                            <table width="650" height="27" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="650" height="27" colspan="3" align="right">共有
										<?php
										echo $total;
										?>
										...
										if ($page >= 2){
										?>
                                        <a href="teaching.php?page=1" title="首页"></a>
                                        <a href="teaching.php?page=<?php echo $page - 1; ?>" title="前一页">
											<?php
											}
											if ($pagecount <= 4) {
												...
												for ($i = 1; $i <= 4; $i++) {
                                                    ...
                                                    <a href="teaching.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
												<?php } ?>
                                                <a href="teaching.php?page=<?php echo $page - 1; ?>" title="后一页"></a>
                                                <a href="teaching.php?page=<?php echo $pagecount; ?>" title="尾页"></a>
											<?php } ?>
                                    </td>
                                </tr>
                            </table>
