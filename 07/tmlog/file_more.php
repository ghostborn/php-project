                                    ...
                                    <table width="90%" border="0" align="center" cellpadding="3" cellspacing="1"
                                        ...
                                        <tr align="left">
                                            <td height="25" valign="top" bgcolor="#EFF7DE"><span
                                                        class="tableBorder_LTR"> 查看全部博客文章 </span></td>
                                        </tr>
										<?php
										...
										$sql = mysqli_query($link,
											"select id,title from tb_article order by id desc limit $offset, $page_size");
										$info = mysqli_fetch_array($sql);
										if ($result){
										?>
                                        <tr>
																...
																do {
                                                                    ...
                                                                    <tr>
                                                                        <td height="35" style="padding-left:30px"><a
                                                                                    ...
                                                                                    href="article.php?file_id=<?php echo $info['id']; ?>"><?php echo $i . "、" . $info['title']; ?></a>
                                                                        </td>
                                                                    </tr>
																	<?php
																	$i = $i + 1;
