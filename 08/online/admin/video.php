        ...
        <tr>
          <td colspan="4" class="style1"><table width="395" border="0" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td width="104" height="30" align="center" valign="middle">名称</td>
                <td width="60" height="30" align="center" valign="middle">类别</td>
                <td width="138" height="30" align="center" valign="middle">主演</td>
                <td height="37" align="center" valign="middle">操作</td>
              </tr>
              <?php
					$sqlstr = "select * from tb_video";//定义查询语句
              ...
              <tr>
                ...
                <td height="18" align="center" valign="middle"><?php echo $rst[6]; ?></td>
				 <td height="18" align="center" valign="middle"><a href="del_video_chk.php?id=<?php echo $rst[0]; ?>" onclick="return del_chk();">删除</a></td> 
				</form>
              </tr>
              <?php 
			  		}
