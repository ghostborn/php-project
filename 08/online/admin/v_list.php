...
$l_sqlstr = "SELECT * FROM tb_videolist";//定义查询语句
                        ...
                        <table width="375" border="0" align="center" cellpadding="2" cellspacing="2">
                            <tr>
                                <td height="10" colspan="5" align="right" valign="middle">
                                    <a href="#" onclick="javacript:Wopen=open('operation.php?action=videolist','添加目录','height=500,width=665,scrollbars=no');">目录添加</a>
                                </td>
                            </tr>
                            <tr>
							...
							while ($l_rst = $result->fetch(PDO::FETCH_NUM)) {//循环输出查询结果
                                ...
                                <tr>
                                    ...
                                    <td height="18" align="center" valign="middle"><a
                                                href="del_list_chk.php?action=videolist&id=<?php echo $l_rst[0]; ?>"
                                                onclick="return del_chk();">删除</a>
                                    </td>
                                </tr>
								<?php
							}
