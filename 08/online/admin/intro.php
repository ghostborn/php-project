...
<?php	$sql="select * from tb_audio where id=".$_GET['id'];//定义查询语句
...
?>
		<table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
				...
				<input name="Submit" type="button" value="  播  放  " onClick="javascript:Wopen=open('operation.php?action=listen&id=<?php echo $rst[16]; ?>','','height=700,width=665,scrollbars=no');">

				<input name="Submit" type="button" value="  下  载  "  onClick="javascript:Wopen=location='download.php?action=audio&id=<?php echo $rst[16]; ?>';">			                    
