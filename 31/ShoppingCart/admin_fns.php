        ...
        <table border="0">
            <tr>
                ...
                <td><input type="text" name="catname" size="40" maxlength="40"
                           value="<?php echo htmlspecialchars($edit ? $category['catname'] : ''); ?>"/>
                </td>
            </tr>
            <tr>
                <td <?php if (!$edit) {
        ...
        <table border="0">
            <tr>
                ...
                <td><input type="text" name="isbn"
                           value="<?php echo htmlspecialchars($edit ? $book['isbn'] : ''); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Book Title:</td>
                <td><input type="text" name="title"
                           value="<?php echo htmlspecialchars($edit ? $book['title'] : ''); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Book Author:</td>
                <td><input type="text" name="author"
                           value="<?php echo htmlspecialchars($edit ? $book['author'] : ''); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Category:</td>
            ...
            <tr>
                ...
                <td><textarea rows="3" cols="50"
                              name="description"><?php echo htmlspecialchars($edit ? $book['description'] : ''); ?></textarea>
                </td>
            </tr>
            <tr>
                <td <?php if (!$edit) {
...
<form action="change_password.php" method="post">
	...
	function insert_category($catname): bool
	{
	...
	function insert_book($isbn, $title, $author, $catid, $price, $description): bool
	{
	...
	function update_category($catid, $catname): bool
	{
	...
	function delete_category($catid): bool
	{
	...
	function delete_book($isbn): bool
	{
